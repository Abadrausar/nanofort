...
local fluids = rubble.require "libs_dfhack_fluids"

local pwshops = rubble.require "workshops_libs_dfhack_powered"
local pitems = rubble.require "items_libs_dfhack_powered"
local ppersist = rubble.require "persist_libs_dfhack_powered"
local pdisaster = rubble.require "disaster_libs_dfhack_powered"
local punits = rubble.require "units_libs_dfhack_powered"
...
pwshops.Register("DFHACK_POWERED_DRILLING_RIG", nil, powerPerLevel, 200, makeDrillPump, 3, 3, nil, nil, true)
