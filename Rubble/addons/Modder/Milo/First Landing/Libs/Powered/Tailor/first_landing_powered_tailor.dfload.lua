...
preact.AddRecipe("DFHACK_POWERED_FL_AUTOTAILOR", {
...
pwshops.Register("DFHACK_POWERED_FL_AUTOTAILOR", nil, 30, 0, 500, preact.MakeHandler("DFHACK_POWERED_FL_AUTOTAILOR", {
...
eventful.registerReaction("ADJUST_POWERED_FL_AUTOTAILOR", clothierAdjust)
