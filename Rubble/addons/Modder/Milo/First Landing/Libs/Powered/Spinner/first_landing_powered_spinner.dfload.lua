...
preact.AddRecipe("DFHACK_POWERED_FL_AUTOSPINNER", {
...
pwshops.Register("DFHACK_POWERED_FL_AUTOSPINNER", nil, 20, 0, 500, preact.MakeHandler("DFHACK_POWERED_FL_AUTOSPINNER", {
