...
This mod is intended to replace the current list of above ground and highly redundant domestic animals with a shorter list of more diverse and thematic creatures based on mountain and subterranean beasts. It also enables generic honey, the use of nail as a kind of horn, chitin as shell and feathers as pearls.
Visit [Deeper Dwarven Domestication][] mod for more information.
...
This was intentionally built with compatibility in mind.  The enhancement mod only overwrites the reaction_other.txt raw file.  The replacement mod overwrites both the reaction_other.txt and creature_domestic.txt raw files.  The new creature_domestic.txt file is a modified version of Igfig's 'Modest Mod' creature file.

If you are using another mod which interacts with these files, whichever mod is loaded last will take precedence.  You may need to manually merge the affected raws.  The only modification to the reaction_other raw is the MAKE_MEAD reaction, to allow dewbeetle honeydew to be brewed using the vanilla reaction.
