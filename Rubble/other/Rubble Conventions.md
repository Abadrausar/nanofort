...
file, as including the version number prevents users from using the .webload system to automatically updating their
local copy of your addon. To better support the .webload system you should always use DFFD for addon uploads, as most
other file hosting sites do not support the direct downloads needed for the .webload system to work.
...
* `creature_FL_fauna_default_vermin.txt`: A creature file for the addon `First Landing/Planets/Fauna/Default Vermin`.
