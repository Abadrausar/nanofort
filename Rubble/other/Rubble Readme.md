...
Rubble. Add the following lines to "rubble.ini":
	...
	# "df:", and "out:" location IDs work) or an OS path (which may be relative or absolute).
...
If you commonly set certain configuration variables when you generate you may want to create a
"userconfig.ini" file. To do this the easy way simply generate a set of raws with the options you want,
then copy "genconfig.ini" from your raw directory to your Rubble directory and rename it to "userconfig.ini".
