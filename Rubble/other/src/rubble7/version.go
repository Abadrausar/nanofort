...
var VMajor, VMinor, VPatch = 7, 7, 1

// Experimental, beta, and other special versions may specify an extra ID to add to the standard version string.
// This will automatically be set to "Internal Test Build" if rubble was built with the build constraint "alpha" satisfied.
var VExtra = ""
...
func init() {
	...
	Version = strconv.Itoa(VMajor) + "." + strconv.Itoa(VMinor) + "." + strconv.Itoa(VPatch) + VExtra
}
