...
// LogicalFile is a simple logical file, basically an interface to a byte buffer.
...
// rw controls if Write and WriteAll work.
...
// Used to attach the needed Close method.
