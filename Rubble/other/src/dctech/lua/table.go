...
// This file is saved as UTF-8 with BOM because Notepad++ randomly interprets the text as TIS-620 (Thai) and eats the
// section characters ('§' ALT+0167, ALT+21) if it is saved as normal UTF-8.
...
// Set to 0 for zero based indexing. This is only partly tested!
