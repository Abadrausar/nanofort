...
func (p *parserAlt) funcCall(ident Expr) Expr {
	line := p.l.current.Line
	var r, f Expr
...
func (p *parserAlt) funcDeclBody(hasSelf bool) Expr {
	// Read Parameters
	p.l.getCurrent(tknOParen)
	line := p.l.current.Line
	params := []string{}
...
func (p *parserAlt) tblConstruct() Expr {
	vals, keys := []Expr{}, []Expr{}
...
func (p *parserAlt) expression() Expr {
	return p.valOr()
}

func (p *parserAlt) valOr() Expr {
	l := p.valAnd()
...
func (p *parserAlt) valShift() Expr {
	l := p.valConcat()
...
func (p *parserAlt) valConcat() Expr {
	l := p.valAdd()
	// No loop!
...
func (p *parserAlt) suffixedValue() Expr {
	l := p.primaryValue()
...
func (p *parserAlt) primaryValue() Expr {
	switch p.l.look.Type {
	case tknName:
		p.l.getCurrent(tknName)
