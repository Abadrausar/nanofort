...
// NewFileInfo creates a new FileInfo object with the given information.
// "name" can be left blank, PosString will automatically compensate.
func NewFileInfo(name string, line, size int) *FileInfo {
	return &FileInfo{
		name: name,
		offset: line,
		size: size,
...
func (f *FileInfo) Position(offset int) (name string, line, column int) {
...
func (f *FileInfo) PosString(offset int) string {
